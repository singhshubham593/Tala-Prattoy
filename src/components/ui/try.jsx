<div className="bg-black text-white font-sans py-4">
      ...
      gallery 
       ...
       return (
    <section className="bg-gray-900 py-10 px-4 md:px-16 text-white">
      <h2 className="text-3xl font-bold mb-6 text-center">Gallery</h2>
      <p className='text-centre text-white mb-4'>Learning provides the environment and inspiration to create and exhibit that brings people together to build connections to community.</p>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {images.map((src, i) => (
          <img key={i} src={src} alt={`gallery-${i}`} className="rounded-lg" />
        ))}
      </div>
    </section>
  );
